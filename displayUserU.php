...
?>
        ...
        <body>
            <div class="container">
                <br>
                <h2 class="text-center text-uppercase"><b>Update User Details</b></h2>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="updateUser.php" method="post">
                            ...
                            <input value="<?php echo $row['department']; ?>" type="text" name="dept" class="form-control" required id="">
                            <label for=""><b class="text-light">Username</b></label>
                            <input value="<?php echo $row['username']; ?>" type="text" name="sname" class="form-control" required id="">
                            <label for=""><b class="text-light">Password</b></label>
                            <input value="<?php echo $row['[password]']; ?>" type="text" name="pass" class="form-control" required id="">
                            <hr>
                            <div class="buttons">
                                <button class="btn btn-primary" type="submit">Update</button>
                                &nbsp;
                                <a href="adminUser.php" class="btn btn-secondary">Cancel Update</a>
                            </div>
                        </form>
                    </div>
                    <div class="col-md-3"></div>
