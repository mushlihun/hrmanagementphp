...
?>
        ...
        <body>
            <div class="container">
                <br>
                <h2 class="text-center text-uppercase text-light"><b>DELETE Staff Details</b></h2>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form action="deleteStaff.php" method="post">
                            ...
                            <input value="<?php echo $row['job_title']; ?>" type="text" style="color: black;" name="jTitle" class="form-control" required readonly id="">
                            ...
                            <input value="<?php echo $row['join_date']; ?>" type="datetime-local" style="color: black;" name="jDate" class="form-control" required readonly id="" style="color: black;" readonly>
                            ...
                            <br>
                            <div class="buttons">
                                <button class="btn btn-outline-danger" type="submit"><b class="text-white">DELETE STAFF</b></button>
                                &nbsp;&nbsp;
                                <a href="registerStaff.php" class="btn btn-outline-success"><b style="color: white;">CANCEL DELETE</b></a>                                
                            </div>
